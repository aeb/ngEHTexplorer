...
class DataSetSelectionPage(BoxLayout) :
    ...
    def __init__(self,**kwargs) :
        ...
        self.ic.add_image([path.abspath(path.join(path.dirname(__file__),"source_images/binary_jet_086.png")),
                          ...
                          "Cartoon binary jets with a flux ratio of 10:1.",
                          False)
        ...
        self.ic.add_image([path.abspath(path.join(path.dirname(__file__),"source_images/binary_jet2_086.png")),
                          ...
                          "Cartoon binary jets with a flux ratio of 100:1.",
                          False)
        

        self.ic.add_image([path.abspath(path.join(path.dirname(__file__),"source_images/binary_point_086.png")),
                           path.abspath(path.join(path.dirname(__file__),"source_images/binary_point_230.png")),
                           path.abspath(path.join(path.dirname(__file__),"source_images/binary_point_345.png")),
                           path.abspath(path.join(path.dirname(__file__),"source_images/binary_point_480.png")),
                           path.abspath(path.join(path.dirname(__file__),"source_images/binary_point_690.png"))],
                          [path.abspath(path.join(path.dirname(__file__),"source_images/binary_point_086.npy")),
                           path.abspath(path.join(path.dirname(__file__),"source_images/binary_point_230.npy")),
                           path.abspath(path.join(path.dirname(__file__),"source_images/binary_point_345.npy")),
                           path.abspath(path.join(path.dirname(__file__),"source_images/binary_point_480.npy")),
                           path.abspath(path.join(path.dirname(__file__),"source_images/binary_point_690.npy"))],
                          "Cartoon binary point sources with a flux ratio of 300:1.",
                          False)

        self.ic.add_image([path.abspath(path.join(path.dirname(__file__),"source_images/xrb_jet_086.png")),
                           path.abspath(path.join(path.dirname(__file__),"source_images/xrb_jet_230.png")),
                           path.abspath(path.join(path.dirname(__file__),"source_images/xrb_jet_345.png")),
                           path.abspath(path.join(path.dirname(__file__),"source_images/xrb_jet_480.png")),
                           path.abspath(path.join(path.dirname(__file__),"source_images/xrb_jet_690.png"))],
                          [path.abspath(path.join(path.dirname(__file__),"source_images/xrb_jet_086.npy")),
                           path.abspath(path.join(path.dirname(__file__),"source_images/xrb_jet_230.npy")),
                           path.abspath(path.join(path.dirname(__file__),"source_images/xrb_jet_345.npy")),
                           path.abspath(path.join(path.dirname(__file__),"source_images/xrb_jet_480.npy")),
                           path.abspath(path.join(path.dirname(__file__),"source_images/xrb_jet_690.npy"))],
                          "Cartoon X-ray binary jet.",
                          False)
